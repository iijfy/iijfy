![header](https://capsule-render.vercel.app/api?type=waving&color=0:2DD4BF,100:2563EB&height=220&section=header&text=Morgan%20Kim&fontSize=60&fontColor=FFFFFF&animation=fadeIn)
...
- SolBridge International School of Business, BBA
    - International Buniness & Marketing

▫️**Experience**
- 미디어포스 얼라이언스(M4A) — UX 신한은행 리뉴얼  
- 아싸겟 / 핏보소 / 씨리얼 스튜디오 — 이커머스/운영 및 공간대여  
- Morgan Universal Media Contents — K콘텐츠 제작·해외배급 / MCN 광고 제작  
- 초록뱀미디어 — 드라마사업본부  
- SMC — MCN 사업본부  
...
<!-- 큰 축(너 이력서 축) -->
![LLM/RAG](https://img.shields.io/badge/LLM%2FRAG-111827?style=flat)
![DL/NLP](https://img.shields.io/badge/DL%2FNLP-111827?style=flat)
![Deploy](https://img.shields.io/badge/Deploy-111827?style=flat)
